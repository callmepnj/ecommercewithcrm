...
// Category hero banners using local images
const categoryBanners: Record<string, { image: string; tagline: string; taglineHi: string }> = {
  saree: {
    image: "/images/sarees/saree-4.jpg",
    tagline: "Drape the Tradition, Wear the Grace",
    taglineHi: "परंपरा ओढ़ें, सुंदरता पहनें",
  },
  kurti: {
    image: "/images/kurtis/kurti-7.jpg",
    tagline: "Effortless Elegance, Everyday Style",
    taglineHi: "सहज सुंदरता, रोज़ाना शैली",
  },
};
